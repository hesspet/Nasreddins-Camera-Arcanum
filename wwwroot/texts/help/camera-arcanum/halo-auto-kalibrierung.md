...
- Wenn die automatische Trennung einen sichtbaren **Halo** (hellen Hof) um die Person legt
- Wenn Körperteile **abgeschnitten** werden
- Wenn der Hintergrund durch die Person **durchscheint** (Randleck)

## So funktioniert's

1. Tippe auf **"Halo-Auto-Kalibrierung"**
2. Die App führt eine Test-Trennung mit verschiedenen Einstellungen durch
3. Die besten Werte werden übernommen und in die Trennungsparameter geschrieben
4. Die Trennung wird automatisch mit den neuen Werten wiederholt
