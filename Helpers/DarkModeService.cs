...
public class DarkModeService
{
    ...
    /// <summary>
    /// Lädt den gespeicherten Darkmode-Zustand aus dem localStorage.
    ...
    public async Task StelleSicherInitialisiertAsync()
    {
        ...
        {
            // Wenn der Zugriff auf localStorage fehlschlägt, bleibt der Standardwert (true = Darkmode) bestehen.
        }
    }
